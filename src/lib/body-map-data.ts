...
const dogSites: BodySite[] = [
  ...
  { id: "dog-side-rectum", label: "Rectum / anus", view: "side", cx: 80, cy: 48 },
...
const catSites: BodySite[] = [
  ...
  { id: "cat-side-rectum", label: "Rectum / anus", view: "side", cx: 82, cy: 50 },
...
const otherSites: BodySite[] = [
  ...
  { id: "other-side-rectum", label: "Rectum / anus", view: "side", cx: 80, cy: 54 },
